    ...
    <>
      <div className='_txMainValue'>
        {ens
          ...
          : <span className='_txRecipient'>{checkSummedAddress.substring(0, 8)}{svg.octicon('kebab-horizontal', { height: 15 })}{checkSummedAddress.substring(address.length - 6)}</span>
        }

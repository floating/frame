              ...
              <React.Fragment>
                ...
                <div className='signerAddress'>
                  <div className='transactionToAddress'>
                    <div className='transactionToAddressLarge'>{this.props.accounts[0].substring(0, 13)} {svg.octicon('kebab-horizontal', {height: '14px'})} {this.props.accounts[0].substr(this.props.accounts[0].length - 13)}</div>

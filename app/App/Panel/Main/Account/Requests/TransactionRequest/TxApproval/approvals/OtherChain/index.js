...
class OtherChain extends React.Component {
  constructor (...args) {
    super(...args)
  ...
  approve () {
    if (this.props.allowOtherChain) this.props.allowOtherChain()
  }
        ...
        >
          ...
          <div className='approveTransactionWarningMessage'>
            <div className='approveTransactionWarningMessageInner'>
              {'transaction is not on currently selected chain'}
            </div>
          </div>
        </div>
      </div>
...
export default Restore.connect(OtherChain)

            ...
            <div className="tokenRow">
              <div className="tokenSymbol">
                ...
                <input
                  ...
                  onFocus={(e) => {
                    if (e.target.value === this.symbolDefault) {
              ...
              <div className="tokenDecimals">
                ...
                <input
                  ...
                  onFocus={(e) => {
                    if (e.target.value === this.decimalsDefault) {
                      this.setState({ decimals: '' })
                    }
                  }}
                  onBlur={(e) => {
              ...
              <div className="tokenChainId">
                ...
                <input
                  ...
                  onFocus={(e) => {
                    if (e.target.value === this.chainDefault) {
                      this.setState({ chainId: '' })
                    }
                  }}
                  onBlur={(e) => {
            ...
            <div className="tokenRow">
              <div className="tokenAddress">
                ...
                <input
                  ...
                  onFocus={(e) => {
                    if (e.target.value === this.addressDefault) {
            ...
            <div className="tokenRow">
              <div className="tokenLogoUri">
                ...
                <input
                  ...
                  onFocus={(e) => {
                    if (e.target.value === this.logoURIDefault) {
                      this.setState({ logoURI: '' })
                    }
                  }}
                  onBlur={(e) => {
                    if (e.target.value === '') {

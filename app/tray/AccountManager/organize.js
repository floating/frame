export const findRoute = (data, id, route = []) => {
...
export const removeByRoute = (data, route) => {
  if (route.length === 1) {
...
export const addByRoute = (data, route, item, position) => {
...
export const insertByGroupRoute = (data, route, item, position) => {
  // const index = route[route.length - 1]

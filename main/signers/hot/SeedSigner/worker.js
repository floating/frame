...
const unlockAccount = async ({ encryptedSeed, password }, pseudoCallback) => {
...
const signMessage = async ({ index, message }, pseudoCallback) => {
...
const signTransaction = async ({ index, rawTx }, pseudoCallback) => {
  // Make sure account is unlocked
  if (!seed) return pseudoCallback('Account locked')
  // Create tranasction
...
const verifyAddress = async ({ index, address }, pseudoCallback) => {
  // Make sure account is unlocked
  if (!seed) return pseudoCallback('Account locked')
  // Construct message
  const message = uuid()

...
const api = {
  ...
  showTray: () => {
    ...
    const height = dev && !fullheight ? 740 : screen.workArea.height === screen.bounds.height ? screen.workArea.height - 50 : screen.workArea.height
    windows.tray.setMinimumSize(358, height)
    windows.tray.setSize(358, height)

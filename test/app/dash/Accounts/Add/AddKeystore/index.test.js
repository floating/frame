...
describe('selecting a keystore', () => {
  const index = 0
  let user, selectKeystoreButton, component

  beforeEach(() => {
    component = setupComponent(<AddKeystore accountData={{}} />)
    ;({ user } = component)
    selectKeystoreButton = component.getAllByRole('button')[index]
  })
  ...
  it('should display any errors raised whilst selecting the keystore file', async () => {
    ...
    expect(component.getAllByRole('button')[index].textContent).toBe('ERROR HERE')
  })
...
//     const continueButton = getAllByRole('button')[0] //TODO: change after animations added
...
//   })
// })
//TODO: resolve after transitions added... will need to re-jig the indexes...
...
//     expect(link.rpc).toHaveBeenCalledWith('createFromPhrase', keystore, signerPassword, expect.any(Function))
//   })
...
//       expect(passwd).toBe(signerPassword)
//       cb(null, { id: '1234' })
//     })

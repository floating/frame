...
describe('setting token address', () => {
  ...
  it('should retrieve token metadata from a connected chain when an address is entered', async () => {
    ...
    expect(link.invoke).toHaveBeenCalledWith('tray:getTokenDetails', '0x3432b6a60d23ca0dfca7761b7ab56459d9c964d0', 137)
  })
})
...
describe('setting token details', () => {
  it('should prompt for default token details', () => {
    const { getByLabelText, getByRole } = render(
      <AddToken data={{ notifyData: { chainId: 137, address: '0x64aa3364F17a4D01c6f1751Fd97C2BD3D7e7f1D4' }}} />
    )
  ...
  it('should update with loaded token metadata', async () => {
    ...
    link.send.mockImplementation(() => {
      rerender(<AddToken data={{ notifyData: { chainId: 137, address: '0x3432b6a60d23ca0dfca7761b7ab56459d9c964d0' }}} />)
    })

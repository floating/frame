                ...
                <div className='addAccountItemOptionSetupFrame'>
                  ...
                  <div className='addAccountItemOptionInputPhrase'>
                    <input
                      type='password'
                      tabIndex='-1'
                      ref={this.forms.enterPrivateKey}
                      value={this.state.privateKey}
                      onChange={(e) => this.onChange('privateKey', e)}
                      onFocus={(e) => this.onFocus('privateKey', e)}
                      onBlur={(e) => this.onBlur('privateKey', e)}
                      onKeyPress={(e) => this.keyPress(e, () => this.next())}
                    />
                  </div>
                  <div className='addAccountItemOptionSubmit' onClick={() => this.next()}>
                    Next
                  </div>
                </div>
                <div className='addAccountItemOptionSetupFrame'>
                  ...
                  <div className='addAccountItemOptionInputPhrase addAccountItemOptionInputPassword'>
                    ...
                    <input
                      type='password'
                      tabIndex='-1'
                      ref={this.forms.manualCreatePassword}
                      value={this.state.password}
                      onChange={(e) => this.onChange('password', e)}
                      onFocus={(e) => this.onFocus('password', e)}
                      onBlur={(e) => this.onBlur('password', e)}
                      onKeyPress={(e) => this.keyPress(e, () => this.createManual())}
                    />
                  </div>
                  <div className='addAccountItemOptionSubmit' onClick={() => this.createManual()}>
                    Create
                  </div>
                </div>
                <div className='addAccountItemOptionSetupFrame'>
